//
//  ELearningBrowserMoodleImagePostViewController.h
//  Educate
//
...
@interface ELearningBrowserMoodleImagePostViewController : UIViewController <UITextFieldDelegate, UITextViewDelegate> {
