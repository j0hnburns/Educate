//
//  TeachingThinkingStrategiesViewController.h
//  Educate
//
...
@interface TeachingThinkingStrategiesViewController : UIViewController <UITableViewDelegate, UITableViewDataSource> { 
...
@property (nonatomic, retain) UITableView *strategiesTableView;
