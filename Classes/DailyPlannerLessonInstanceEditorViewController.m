//
//  DailyPlannerLessonInstanceEditorViewController.m
//  Educate
//
...
@implementation DailyPlannerLessonInstanceEditorViewController
...
- (id)initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil {
    if (self = [super initWithNibName:nibNameOrNil bundle:nibBundleOrNil]) {
		...
		customNavHeader.viewHeader.text = @"Lesson Editor";
		customNavHeader.upperSubHeading.text = @"Weekday";
		...
		periodNameField = [[UITextField alloc] initWithFrame:CGRectMake(75, 144, 200.0, 30)];
		...
		selectClassButton = [[UIButton buttonWithType:UIButtonTypeCustom] retain];
		selectClassButton.frame = CGRectMake(275, 144, 32, 32);
		[selectClassButton setImage:[UIImage imageNamed:@"accessoryArrow.png"] forState:UIControlStateNormal];
		[selectClassButton addTarget:self action:@selector(selectLessonNameFromDatabase) forControlEvents:UIControlEventTouchUpInside];
		selectClassButton.hidden = YES;
		[self.view addSubview:selectClassButton];
		
		
		
		UILabel* labelClassroom = [[UILabel alloc] initWithFrame:CGRectMake(20.0, 184.0, 50.0, 30)];
		...
		classroomField = [[UITextField alloc] initWithFrame:CGRectMake(75, 184, 230.0, 30)];
		...
		/*
		 UILabel* labelNotes = [[UILabel alloc] initWithFrame:CGRectMake(20.0, 150.0, 300.0, 30)];
		 labelNotes.text = @"Notes:";
		 labelNotes.backgroundColor = [UIColor clearColor];
		 labelNotes.textColor = [UIColor darkGrayColor];
		 labelNotes.textAlignment = UITextAlignmentLeft;
		 labelNotes.font = [UIFont boldSystemFontOfSize:15];
		...
		notesView.autocorrectionType=UITextAutocorrectionTypeYes;
		...
		[saveEditButton.titleLabel setFont:[UIFont boldSystemFontOfSize:14]];
		...
		[showNotesHistoryButton.titleLabel setFont:[UIFont boldSystemFontOfSize:14]];
		...
		saveButton.titleLabel.font = [UIFont boldSystemFontOfSize:14];
		...
		newNoteButton.titleLabel.font = [UIFont boldSystemFontOfSize:14];
...
- (void)selectLessonNameFromDatabase {
	DailyPlannerLessonSelectionViewController *dailyPlannerLessonSelectionViewController = [[DailyPlannerLessonSelectionViewController alloc] initWithNibName:nil bundle:nil];    
	dailyPlannerLessonSelectionViewController.localLessonSetupArray = [localPlannerSubjectArray objectAtIndex:0];	
	dailyPlannerLessonSelectionViewController.weekday = weekday;
	dailyPlannerLessonSelectionViewController.periodID = periodID;
	[[self navigationController] pushViewController:dailyPlannerLessonSelectionViewController animated:YES];
	[dailyPlannerLessonSelectionViewController release];
...
- (void)viewWillAppear:(BOOL)animated {
	...
	if ([localPlannerSubjectArray count] == 1) {
		...
		//customNavHeader.upperSubHeading.text = [NSString stringWithFormat:@"Day %i", [weekday intValue]+1];	
		...
		customNavHeader.upperSubHeading.text = [NSString stringWithFormat:@"%@",[plannerColumnHeaderArray objectAtIndex:[weekday intValue]]];	
		[plannerColumnHeaderArray release];
